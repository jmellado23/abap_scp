CLASS zcl_renting_load_data_jmf  DEFINITION
PUBLIC
FINAL
CREATE PUBLIC .
  PUBLIC SECTION.
...
CLASS zcl_renting_load_data_jmf IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA: lt_brands    TYPE TABLE OF zrent_brands_jmf,
          lt_cars      TYPE TABLE OF zrent_cars_jmf,
          lt_customers TYPE TABLE OF zrent_custmr_jmf.
** BRANDS **
    lt_brands = VALUE #(
    ...
    DELETE FROM zrent_brands_jmf.
    INSERT zrent_brands_jmf FROM TABLE @lt_brands.
    SELECT * FROM zrent_brands_jmf INTO TABLE
    @lt_brands.
    out->write( sy-dbcnt ).
    out->write( 'zrent_brands_jmf data insertedsuccessfully!' ).
...
** CARS**
    lt_cars = VALUE #(
        ...
        ( matricula = '1246GSA' marca = 'BMW' modelo = 'SERIE 4' color = 'BLANCO' motor = '2.5' potencia = '210' und_potencia = 'CV' combustible = 'GASOLINA' consumo = '7.00'
          fecha_fabr = '20200418' puertas = '5' precio = '210' moneda = 'USD' alquilado = 'X' alq_desde = '20211201' alq_hasta = '20211231' )
        ...
        fecha_fabr = '20200617' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde = '20200801' alq_hasta = '20200831' )
        ...
        fecha_fabr = '20200304' puertas = '3' precio = '140' moneda = 'USD' alquilado = 'X' alq_desde = '20210701' alq_hasta = '20210708' )
        ...
        fecha_fabr = '20200924' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde = '20200601' alq_hasta = '20201001' )
        ...
        fecha_fabr = '20200726' puertas = '5' precio = '160' moneda = 'USD' alquilado = 'X' alq_desde = '20200301' alq_hasta = '20210301' )
        ...
        fecha_fabr = '20200614' puertas = '5' precio = '180' moneda = 'USD' alquilado = 'X' alq_desde = '20211201' alq_hasta = '20211206' )
        ...
        fecha_fabr = '20210716' puertas = '5' precio = '180' moneda = 'USD' alquilado = 'X' alq_desde = '20211201' alq_hasta = '20211206' )
        ...
        fecha_fabr = '20200812' puertas = '3' precio = '150' moneda = 'USD' alquilado = 'X' alq_desde = '20211106' alq_hasta = '20211206' )

   ).

    DELETE FROM zrent_cars_jmf.
    INSERT zrent_cars_jmf FROM TABLE @lt_cars.
    SELECT * FROM zrent_cars_jmf INTO TABLE @lt_cars.
    out->write( sy-dbcnt ).
    out->write( 'zrent_cars_jmf data insertedsuccessfully!' ).
...
*    * CUSTOMERS**
    ...
    DELETE FROM zrent_custmr_jmf.
    INSERT zrent_custmr_jmf FROM TABLE @lt_customers.
    SELECT * FROM zrent_custmr_jmf INTO TABLE
    @lt_customers.
    out->write( sy-dbcnt ).
    out->write( 'zrent_custmr_jmf data insertedsuccessfully!' ).
